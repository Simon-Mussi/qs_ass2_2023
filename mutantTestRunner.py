...
mutant_files = [f'./Mutants/mutantsJars/mbMutant{i}.jar' for i in range(1,7)]
...
shutil.copy('./src/test/scala/at/tugraz/ist/qs2023/MessageBoardSpecification.scala', './Mutants/src/test/scala/at/tugraz/ist/qs2023/')
...
for index, mutant_jar in enumerate(mutant_files):
    ...
    output = ''
    with open('./Mutants/build/reports/tests/test/classes/at.tugraz.ist.qs2023.MessageBoardSpecificationTest.html', 'r') as file:
        output = file.read()
